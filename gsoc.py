...
r = requests.get('https://summerofcode.withgoogle.com/archive/'+str(t)+'/organizations/') #URL of gsoc

if r.status_code == 404:
    print('Archive of this year is not available. Please run the file again with valid year.')
    exit()
